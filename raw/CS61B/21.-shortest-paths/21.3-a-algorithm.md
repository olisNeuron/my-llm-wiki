...
<figure><img src="/files/4wNShNRzBaeaIYvKrh5K" alt=""><figcaption><p>A*</p></figcaption></figure>
...
```
GET https://cs61b-2.gitbook.io/cs61b-textbook-spring-2026/21.-shortest-paths/21.3-a-algorithm.md?ask=<question>&goal=<endgoal>
```
