...
How many levels are there? We split the array until it is length 1, so $$k=log\_{2}(N)$$. Thus the overall runtime is $$\Theta(N\*log(N))$$.
...
```
GET https://cs61b-2.gitbook.io/cs61b-textbook-spring-2026/13.-asymptotics-iii/13.3-mergesort.md?ask=<question>&goal=<endgoal>
```
